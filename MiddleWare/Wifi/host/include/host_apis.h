...
H_APIs ssv6xxx_result ssv6xxx_wifi_set_highpwr_rate_18_1(bool on);
H_APIs ssv6xxx_result ssv6xxx_wifi_set_b_mode_highpwr(bool on);
...
H_APIs s32 ssv6xxx_set_rc_per(u32 up_pf,u32 down_pf);
H_APIs s32 ssv6xxx_set_rc_resent(bool is_resent);

//Customized
H_APIs void ssv6xxx_get_tx_info(u16 *tx_cnt, u16 *retry_cnt, u16 *phy_rate);
H_APIs ssv6xxx_result ssv6xxx_wifi_set_hw_retry(u32 cnt);

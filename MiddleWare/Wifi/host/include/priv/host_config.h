...
#define MBOX_MAX_MSG_EVENT			32              // Max message event in the system. The vaule should be larger than the amount of RX ID
...
#define RC_RESENT TRUE
#define RC_B_MODE_HIGH_PWR FALSE

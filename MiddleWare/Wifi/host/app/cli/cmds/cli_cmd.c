...
#endif
extern void ssv6xxx_rf_disable(void);
extern void ssv6xxx_rf_enable(void);
...
void bus_loopback(int argc, char **argv)
{
    ...
    while(loop||(forever==TRUE)){
        ...
        ssv6xxx_gen_random(OS_FRAME_GET_DATA(pLoopBackOut),OS_FRAME_GET_DATA_LEN(pLoopBackOut));

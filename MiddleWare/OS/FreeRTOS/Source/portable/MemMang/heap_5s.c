...
typedef struct A_BLOCK_LINK
{
	...
	struct A_BLOCK_LINK *pxNextMallocBlock;	/*<< The next free block in the list. */
	struct A_BLOCK_LINK *pxPreMallocBlock;	/*<< The next free block in the list. */
	TaskHandle_t TCB;						/*Which task malloc the memory. */
